CREATE SCHEMA IF NOT EXISTS demo.public_snowplow_manifest;
USE SCHEMA public_snowplow_manifest;
DROP TABLE IF EXISTS demo.public_snowplow_manifest.events;
CREATE TABLE IF NOT EXISTS demo.public_snowplow_manifest.events (
    app_id STRING,
    platform STRING,
...
COPY INTO events FROM 's3://embucket-testdata/dbt_snowplow_data/events_yesterday.csv' FILE_FORMAT = (TYPE = CSV, SKIP_HEADER = 1, FIELD_OPTIONALLY_ENCLOSED_BY = '"');
